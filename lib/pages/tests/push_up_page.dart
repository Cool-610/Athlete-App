...
class _PushUpPageState extends State<PushUpPage> {
  ...
  Future<void> _stopVideoRecording() async {
    ...
    try {
      ...
      final storageRef = FirebaseStorage.instance.ref().child('push_ups/$fileName');
      ...
      await firestore.collection('push_ups').add({
        'url': downloadUrl,
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 6),
                    Text(
                      "Measure your upper body endurance",
                      style: TextStyle(
                        fontSize: 16,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInstructionItem(1, "Start in a plank position"),
                    const SizedBox(height: 12),
                    _buildInstructionItem(2, "Lower your body until your chest nearly touches the ground"),
                    const SizedBox(height: 12),
                    _buildInstructionItem(3, "Push back up to starting position"),
                    const SizedBox(height: 12),
